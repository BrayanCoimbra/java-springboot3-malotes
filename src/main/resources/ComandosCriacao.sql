...
DROP SEQUENCE IF EXISTS SEQ_SUPMALOTE;
DROP SEQUENCE IF EXISTS SEQ_SUPFUNCIONARIO;
DROP SEQUENCE IF EXISTS SEQ_SUPDESCRICAO;

CREATE SEQUENCE SEQ_SUPFUNCIONARIO START WITH 1 INCREMENT BY 1;
CREATE TABLE SUPFUNCIONARIO (
  SEQCODFUNCIONARIO BIGINT PRIMARY KEY DEFAULT NEXTVAL('SEQ_SUPFUNCIONARIO'),
...
CREATE SEQUENCE SEQ_SUPDESCRICAO START WITH 1 INCREMENT BY 1;
CREATE TABLE SUPDESCRICAO (
  SEQCODDESCRICAO BIGINT PRIMARY KEY DEFAULT NEXTVAL('SEQ_SUPDESCRICAO'),
...
CREATE SEQUENCE SEQ_SUPMALOTE START WITH 1 INCREMENT BY 1;
CREATE TABLE SUPMALOTE (
  SEQCODMALOTE BIGINT PRIMARY KEY DEFAULT NEXTVAL('SEQ_SUPMALOTE'),
  ...
  CONSTRAINT FK_SUPMALOTE_CODFUNCIONARIO
      FOREIGN KEY (CODFUNCIONARIO)
      REFERENCES SUPFUNCIONARIO (SEQCODFUNCIONARIO),

  CONSTRAINT FK_SUPMALOTE_CODDESCRICAO
      FOREIGN KEY (CODDESCRICAO)
      REFERENCES SUPDESCRICAO (SEQCODDESCRICAO)
);
